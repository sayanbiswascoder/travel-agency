export const destination = {
  ...
  tagline: "Land of mangroves and the Royal Bengal Tiger",
  summary:
    "A tidal wilderness of mangrove forests, winding creeks, and unique wildlife — ideal for nature lovers and adventurous travelers seeking river safaris, birdwatching, and quiet eco-lodges.",
};
...
export const packages: TravelPackage[] = [
  {
    ...
    description:
      "Ideal for nature lovers: guided river safaris in search of the Royal Bengal tiger, mangrove walks, and evenings at a quiet eco-lodge.",
  ...
  },
  {
    ...
    description:
      "Perfect for couples seeking intimacy and nature: private boat cruises, candlelit riverside dinners, and guided night safaris.",
  ...
  },
  {
    ...
    description:
      "For adventurous travelers: extended boat safaris, guided mangrove treks, and intensive wildlife and birding experiences.",
  ...
  },
  {
    ...
    description:
      "For travelers seeking deep rest, grounding rituals, and thoughtful luxury inside Bali’s serene countryside.",
    ...
    itinerary: [
      ...
      { day: "Day 3", title: "Organic farming day", description: "Visit a local farm and learn how Bali’s freshest ingredients shape its cuisine." },
